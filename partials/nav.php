<header class="nav-header">
  <div class="nav-inner">
    ...
    <div class="nav-right">
      ...
      <a href="<?= $e($config['site']['mtex_status']) ?>" class="nav-ext-link" target="_blank" rel="noopener noreferrer">
      ...
      <a href="<?= $e($config['site']['github_url']) ?>" class="nav-ext-link" target="_blank" rel="noopener noreferrer">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" class="nav-icon">
